...
#define vspom vspom_Exp2SynNMDA
 extern double vspom( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define alpha_vspom alpha_vspom_Exp2SynNMDA
 double alpha_vspom = -0.062;
#define caComponent caComponent_Exp2SynNMDA
 double caComponent = 0.1;
#define extMgConc extMgConc_Exp2SynNMDA
 double extMgConc = 1;
#define v0_block v0_block_Exp2SynNMDA
 double v0_block = 10;
 ...
 "alpha_vspom_Exp2SynNMDA", "/mV",
 "v0_block_Exp2SynNMDA", "mV",
 "extMgConc_Exp2SynNMDA", "mM",
 "tau1", "ms",
 "tau2", "ms",
 "e", "mV",
 "A", "uS",
 ...
 "alpha_vspom_Exp2SynNMDA", &alpha_vspom_Exp2SynNMDA,
 "v0_block_Exp2SynNMDA", &v0_block_Exp2SynNMDA,
 "caComponent_Exp2SynNMDA", &caComponent_Exp2SynNMDA,
 "extMgConc_Exp2SynNMDA", &extMgConc_Exp2SynNMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp2SynNMDA C:/Users/Celine/Dropbox/Desktop/Celine/Lab/NEURON/fullMorphCaLTP8_five_synapses_extended/fullMorphCaLTP8/nmdaSyn.mod\n");
...
double vspom ( _threadargsprotocomma_ double _lv ) {
   double _lvspom;
 _lvspom = 1. / ( 1. + 0.2801 * extMgConc * exp ( alpha_vspom * ( _lv - v0_block ) ) ) ;
...
static double _hoc_vspom(void* _vptr) {
 ...
 _r =  vspom ( _p, _ppvar, _thread, _nt, *getarg(1) );
 return(_r);
}
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = B - A ;
   mgBlock = vspom ( _threadargscomma_ v ) ;
   i = g * mgBlock * ( v - e ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "nmdaSyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
